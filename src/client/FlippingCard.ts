 ...
 */
function setElementContent (element: { innerHTML: string; appendChild: (arg0: HTMLElement | Text) => void; }, content: any)
{
    var disambiguation;
 ...
 */
FlippingCard.prototype.prepareDom = function (container: { appendChild: (arg0: any) => void; }) {
 ...
 */
FlippingCard.prototype.setQuestion = function (item: { question: any; }) {
 ...
 */
FlippingCard.prototype.setAnswer = function (item: { answer: any; examples: any[]; }) {
    ...
    if (item.examples)
    {
        examplesHtml = item.examples
            .map(function (example: { outerHTML: any; }) {
 ...
 */
FlippingCard.prototype.toggleButtonsState = function (toggle: any) {
 ...
 */
FlippingCard.prototype.questionKeydownHandler = function (event: { keyCode: number; preventDefault: () => void; }) {
    if (40 === event.keyCode)
    {
        this.showAnswer();
 ...
 */
FlippingCard.prototype.answerKeydownHandler = function (event: { keyCode: number; preventDefault: () => void; }) {
    if (37 === event.keyCode)
    {
        this.wrongAnswer();
        event.preventDefault();
